...
const ResourcesDropdown = ({ active }) => {
              ...
              <animated.div style={firstTopFade}>
                ...
                <ul>
                  ...
                  <li>
                    <h2>Help Center</h2>
                    <p>
                      Find answers to your questions and tips for getting the
                      most out of your Todire
                    </p>
                  </li>
                </ul>
              </animated.div>
                  ...
                  <Col>
                    <ul>
                      <li>
                        <h2>Support</h2>
                        <p>
                          Need help? Contact the Todire support team, get how-to
                          help and step by step instructions
                        </p>
                      </li>
                      <li>
                        <h2>Community Programs</h2>
                        <p>
                          Connect with and learn from Todire customers around
                          the world
                        </p>
                      </li>
                      <li>
                        <h2>Developer</h2>
                        <p>
                          Learn more about building appson the Todire platform
                        </p>
                      </li>
                    </ul>
                  </Col>
